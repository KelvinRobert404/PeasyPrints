...
export default function ShopfrontPricingPage() {
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-2 gap-4">
                  <FormField name="a4.singleBW" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Single-sided Black & White</FormLabel>
                      <FormControl>
                  ...
                  <FormField name="a4.doubleBW" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Double-sided Black & White</FormLabel>
                      <FormControl>
                        <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
                  ...
                  <FormField name="a4.singleColor" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Single-sided Color</FormLabel>
                      <FormControl>
                        <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
                  ...
                  <FormField name="a4.doubleColor" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Double-sided Color</FormLabel>
                      <FormControl>
                        <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-2 gap-4">
                  <FormField name="services.softBinding" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Soft Binding</FormLabel>
                      <FormControl>
                        <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
                  ...
                  <FormField name="services.hardBinding" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Hard Binding</FormLabel>
                      <FormControl>
                        <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
                  ...
                  <FormField name="services.spiralBinding" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Spiral Binding</FormLabel>
                      <FormControl>
                        <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
                  ...
                  <FormField name="services.emergency" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Emergency Printing</FormLabel>
                      <FormControl>
                        <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
